 ...
 *
 */
public class adminUtilizadores extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adminUtilizadores window1 = new adminUtilizadores(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public adminUtilizadores(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public adminUtilizadores() {
		initialize();
	}
	...
	private void initialize() {
		...
		button_1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				adminCriarUtilizador aCriarUti = new adminCriarUtilizador();
		...
		btnVoltar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				frame.setVisible(false);
				menu_Admin mA = new menu_Admin(bd,username);
