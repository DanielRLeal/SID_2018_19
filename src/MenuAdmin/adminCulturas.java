 ...
 *
 */
public class adminCulturas extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					adminCulturas window1 = new adminCulturas(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public adminCulturas(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public adminCulturas() {
		initialize();
	}
