...
public class auditorVariaveisMedidas_Log extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					auditorVariaveisMedidas_Log window1 = new auditorVariaveisMedidas_Log(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public auditorVariaveisMedidas_Log(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public auditorVariaveisMedidas_Log() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInicieASesso = new JLabel("Consulta dos Logs das Vari\u00E1veis Medidas");
		lblInicieASesso.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblInicieASesso.setBounds(143, 154, 236, 16);
		...
		JLabel lblMenu = new JLabel("Logs das Vari\u00E1veis Medidas");
		panel.add(lblMenu);
