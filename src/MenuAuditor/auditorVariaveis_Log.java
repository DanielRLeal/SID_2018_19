...
public class auditorVariaveis_Log extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					auditorVariaveis_Log window1 = new auditorVariaveis_Log(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public auditorVariaveis_Log(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public auditorVariaveis_Log() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInicieASesso = new JLabel("Consulta dos Logs das Vari\u00E1veis");
		...
		JLabel lblMenu = new JLabel("Logs de Vari\u00E1veis");
		panel.add(lblMenu);
