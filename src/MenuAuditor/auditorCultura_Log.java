 ...
 *
 */
public class auditorCultura_Log extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					auditorCultura_Log window1 = new auditorCultura_Log(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public auditorCultura_Log(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public auditorCultura_Log() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInicieASesso = new JLabel("Consulta de Logs das Culturas");
		...
		JLabel lblMenu = new JLabel("Log das Culturas");
		panel.add(lblMenu);
