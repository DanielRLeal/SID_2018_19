...
public class ListVariaveisMedidas extends JanelaBase {
	...
	protected void initialize() {
		...
		if(bd.utilizadorLogado.CategoriaProfissional.equals("Administrador")
			...
			JButton btnCriarVariaveisMedidas = btnCriarVariaveisMedidas(table, btnVoltar);
	...
	/**
	 * Btn criar variaveis medidas.
	 *
	 * @param table the table
	 * @param btnVoltar the btn voltar
	 * @return the j button
	 */
	private JButton btnCriarVariaveisMedidas(JTable table, JButton btnVoltar) {
				...
				btnOkEdit.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							bd.actualizarVariaveisMedidas(vm.getIDCultura_fk(), vm.getIDVariavel_fk(),
									Double.parseDouble(LimiteSuperior.getText()),
									Double.parseDouble(LimiteInferior.getText()));
		...
		return btnCriarVariaveisMedidas;
	}
}