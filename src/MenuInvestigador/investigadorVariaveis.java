 ...
 *
 */
public class investigadorVariaveis extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					investigadorVariaveis window1 = new investigadorVariaveis(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public investigadorVariaveis(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public investigadorVariaveis() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInicieASesso = new JLabel("Consulta de Vari\u00E1veis");
