 ...
 *
 */
public class investigadorSistema extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					investigadorSistema window1 = new investigadorSistema(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public investigadorSistema(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public investigadorSistema() {
		initialize();
	}
