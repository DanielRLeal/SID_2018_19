...
public class investigadorCriarMedicaoTemp extends JanelaBase {
	...
	public investigadorCriarMedicaoTemp(BancoDeDados bd) {
		super(bd);
		initialize();
	}
...
//		frame.getContentPane().add(lblDescrioDaCultura);
		...
		btnVoltar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				investigadorMedicoesTemp aMedLum = new investigadorMedicoesTemp(bd);
