 ...
 *
 */
public class investigadorVariaveisMedidas extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					investigadorVariaveisMedidas window1 = new investigadorVariaveisMedidas(bd, username);
				} catch (Exception e) {
					e.printStackTrace();
				}
	...
	public investigadorVariaveisMedidas(BancoDeDados bd, String username) {
		this.username = username;
		this.bd = bd;
	}

	public investigadorVariaveisMedidas() {
		initialize();
	}
	...
	private void initialize() {
		...
		JLabel lblInicieASesso = new JLabel("Consulta das Vari\u00E1veis Medidas");
		lblInicieASesso.setFont(new Font("Tahoma", Font.PLAIN, 12));
		lblInicieASesso.setBounds(168, 154, 236, 16);
		...
		JLabel lblMenu = new JLabel("Vari\u00E1veis Medidas");
		panel.add(lblMenu);
